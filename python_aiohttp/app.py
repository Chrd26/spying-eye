...
# Source of the Client -> Server -> Client: https://github.com/aiortc/aiortc/blob/main/examples/server/server.py
...
class VideoTransformTrack(MediaStreamTrack):
    ...
    async def websocket_handler():
        while True:
            ...
            asyncio.create_task(recv(self))
            # The above line starts the process_frame function as a separate task
            # It doesn't block the execution and allows the loop to continue immediately
